    ...
    namespace JsonTest {
        namespace TestDeserializer {
            ...
            TEST_F(DeserializeVectorTest, TestNames) {
                ...
                Cmarshal::Json::FromJson(m_names, jarray);
                VerifyNames(jarray);
            }
            ...
            TEST_F(DeserializeVectorTest, TestEmails) {
                ...
                Cmarshal::Json::FromJson(&m_emails, jarray);
                VerifyEmails(jarray);
                DeleteEmails();
            }
            ...
            TEST_F(DeserializeVectorTest, TestScores) {
                ...
                Cmarshal::Json::FromJson(&m_scores, jarray);
                VerifyScores(jarray);
                DeleteScores();
            }
            ...
            TEST_F(DeserializeVectorTest, TestCities) {
                ...
                Cmarshal::Json::FromJson(m_cityes, jarray);
                VerifyCities(jarray);
                DeleteCities();
            }
            ...
            TEST_F(DeserializeVectorTest, TestRanks) {
                ...
                Cmarshal::Json::FromJson(m_ranks, jarray);
                VerifyRanks(jarray);
                DeleteRank();
            }
