        ...
        namespace TestSerializer {
            ...
            public:
                ...
                static constexpr auto getters = std::make_tuple(
                        Cmarshal::Json::Getter<SimpleClass, long>(&SimpleClass::GetId, "id"),
                        Cmarshal::Json::Getter<SimpleClass, const string &>(&SimpleClass::GetName, "name"),
                        Cmarshal::Json::Getter<SimpleClass, const string *>(&SimpleClass::GetAddress, "address"),
                        Cmarshal::Json::Getter<SimpleClass, const int *>(&SimpleClass::GetAge, "age"),
                        Cmarshal::Json::Getter<SimpleClass, double>(&SimpleClass::GetScore, "score"),
                        Cmarshal::Json::Getter<SimpleClass, const char *>(&SimpleClass::GetCity, "city"),
                        Cmarshal::Json::Getter<SimpleClass, bool>(&SimpleClass::IsValid, "is_valid"),
                        Cmarshal::Json::Getter<SimpleClass, const vector<int> &>(&SimpleClass::GetVecInt, "int_vector"),
                        Cmarshal::Json::Getter<SimpleClass, const vector<string> &>(&SimpleClass::GetVecString,
                                                                                    "str_vector"),
                        Cmarshal::Json::Getter<SimpleClass, const vector<string *> *>(&SimpleClass::GetVecStringPtr,
                                                                                      "str_vector_ptr"),
                        Cmarshal::Json::Getter<SimpleClass, const vector<double> *>(&SimpleClass::GetVecDouble,
                                                                                    "double_vector"),
                        Cmarshal::Json::Getter<SimpleClass, const vector<char *> &>(&SimpleClass::GetVecChar,
                                                                                    "char_vector"),
                        Cmarshal::Json::Getter<SimpleClass, const vector<long *> &>(&SimpleClass::GetVecLong,
                                                                                    "long_vector")
                );
            };
            ...
            TEST_F(SerializeSimpleObjectTest, SimpleClassTest) {
                ...
                jvalue = Cmarshal::Json::ToJson(SimpleClass());
                Validate(jvalue, obj);
                cout << jvalue.serialize() << endl;

                jvalue = Cmarshal::Json::ToJson(std::move(obj));
                Validate(jvalue, obj);
                cout << jvalue.serialize() << endl;

                jvalue = Cmarshal::Json::ToJson(obj);
                Validate(jvalue, obj);
                cout << jvalue.serialize() << endl;
