    ...
    namespace JsonTest {
        namespace TestSerializer {
            ...
            TEST_F(SerializePremitiveTest, PremitiveInt) {
                ...
                jval = Cmarshal::Json::ToJson(10);
                ASSERT_EQ(10, jval.as_integer());
                jval = Cmarshal::Json::ToJson(int(10));
                ASSERT_EQ(10, jval.as_integer());
                jval = Cmarshal::Json::ToJson(std::move(intVal));
                ASSERT_EQ(intVal, jval.as_integer());

                jval = Cmarshal::Json::ToJson(intVal);
                ...
                jval = Cmarshal::Json::ToJson(uintVal);
                ASSERT_TRUE(jval.is_number());
            ...
            TEST_F(SerializePremitiveTest, PremitiveLong) {
                ...
                jval = Cmarshal::Json::ToJson(10L);
                ASSERT_TRUE(jval.is_number());
                ASSERT_TRUE(jval.as_number().is_int64());
                ASSERT_TRUE(jval.as_number().to_int64() == 10L);

                ASSERT_EQ(10L, jval.as_integer());
                jval = Cmarshal::Json::ToJson(long(10));
                ASSERT_EQ(10L, jval.as_integer());
                jval = Cmarshal::Json::ToJson(std::move(longVal));
                ASSERT_EQ(longVal, jval.as_integer());

                jval = Cmarshal::Json::ToJson(longVal);
                ASSERT_TRUE(jval.is_number());
                ASSERT_TRUE(jval.as_number().is_int64());
                ...
                jval = Cmarshal::Json::ToJson(ulongVal);
                ASSERT_TRUE(jval.is_number());
            ...
            TEST_F(SerializePremitiveTest, PremitiveDouble) {
                ...
                jval = Cmarshal::Json::ToJson(double(10.51));
                ASSERT_DOUBLE_EQ(10.51, jval.as_double());
                jval = Cmarshal::Json::ToJson(std::move(decimalVal));
            ...
            TEST_F(SerializePremitiveTest, PremitiveChar) {
                ...
                jval = Cmarshal::Json::ToJson('A');
                ASSERT_EQ(65, jval.as_integer());
                jval = Cmarshal::Json::ToJson(char('A'));
                ASSERT_EQ(65, jval.as_integer());
                jval = Cmarshal::Json::ToJson(std::move(charValue));
                ASSERT_EQ(intVal, jval.as_integer());

                jval = Cmarshal::Json::ToJson(charValue);
                ASSERT_TRUE(jval.is_number());
                ASSERT_TRUE(jval.as_number().is_int32());
                ASSERT_TRUE(jval.as_number().to_int32() == intVal);
                ASSERT_EQ(intVal, jval.as_integer());
                ...
                jval = Cmarshal::Json::ToJson(ucharVal);
                ASSERT_TRUE(jval.is_number());
                ASSERT_TRUE(jval.as_number().is_int32());
                ASSERT_TRUE(jval.as_number().to_int32() == intVal);
                ASSERT_EQ(intVal, jval.as_integer());
                ...
                jval = Cmarshal::Json::ToJson(charVal2);
                ASSERT_EQ(intVal, jval.as_integer());
                char &charVal3 = charValue;
                jval = Cmarshal::Json::ToJson(charVal3);
                ASSERT_EQ(intVal, jval.as_integer());
                const char &charVal4 = charVal2;
                jval = Cmarshal::Json::ToJson(charVal4);
                ASSERT_EQ(intVal, jval.as_integer());
                char const &charValue5 = intVal;
                jval = Cmarshal::Json::ToJson(charValue5);
                ASSERT_EQ(intVal, jval.as_integer());
            }
