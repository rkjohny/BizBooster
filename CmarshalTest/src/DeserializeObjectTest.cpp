...
// all getters take reference (with/without const) type arguments
            ...
            class SimpleClass2 : public TestSerializableBase {
            public:
                int id;
                std::vector<int> score;
            ...
            REGISTER_SETTER_INCLUDING_BASE_START(TestSerializableBase)
            ...
            public:
                ...
                static constexpr auto setters = std::make_tuple(
                        Cmarshal::Json::Setter<SimpleClass3, int *>(&SimpleClass3::SetId, "id"),
                        Cmarshal::Json::Setter<SimpleClass3, std::vector<int *> *>(&SimpleClass3::SetScore, "score")
                );
            };
...
// it is just to make sure to be compileable
            ...
            public:
                ...
                static constexpr auto setters = std::make_tuple(
                        Cmarshal::Json::Setter<SimpleClass4, const int *>(&SimpleClass4::SetId, "id"),
                        Cmarshal::Json::Setter<SimpleClass4, const std::vector<int *> *>(&SimpleClass4::SetScore,
                                                                                         "score")
                );
            };
...
// NestedClass holdes a SimpleClass1 object (value type)
            ...
            public:
                ...
                static constexpr auto setters = std::make_tuple(
                        Cmarshal::Json::Setter<NestedClass, const SimpleClass1 &>(&NestedClass::SetSimpleObject,
                                                                                  "object"),
                        Cmarshal::Json::Setter<NestedClass, std::vector<SimpleClass1> &>(&NestedClass::SetSimpleObjects,
                                                                                         "objects")
                );
            };
...
// nested class with pointer type member object
            ...
            public:
                ...
                static constexpr auto setters = std::make_tuple(
                        Cmarshal::Json::Setter<NestedClass2, SimpleClass1 *>(&NestedClass2::SetSimpleObject, "object"),
                        Cmarshal::Json::Setter<NestedClass2, std::vector<SimpleClass1 *> *>(
                                &NestedClass2::SetSimpleObjects, "objects")
                );
            };
...
// nested class contains double pointer
            ...
            public:
                ...
                static constexpr auto setters = std::make_tuple(
                        Cmarshal::Json::Setter<NestedClass3, SimpleClass1 **>(&NestedClass3::SetSimpleObject, "object"),
                        Cmarshal::Json::Setter<NestedClass3, std::vector<SimpleClass1 **> **>(
                                &NestedClass3::SetSimpleObjects, "objects")
                );
            };
            ...
            TEST(DeserializeObjectTest, TestSimpleClass1) {
                ...
                Cmarshal::Json::FromJson(objPtr, jvalue);
                ...
                Cmarshal::Json::FromJson(objPtr2, jvalue);
            ...
            TEST(DeserializeObjectTest, NestedClassTest) {
                ...
                Cmarshal::Json::FromJson(nestObject, jvalNestObj);
                ...
                Cmarshal::Json::FromJson(objptr, jvalNestObj);
                ...
                Cmarshal::Json::FromJson(objPtr2, jvalNestObj);
