...
namespace CmarshalTest {
    namespace JsonTest {
        namespace TestSerializer {
            ...
            class ClassB : public TestSerializableBase {
            private:
                ClassA m_obj;
                ClassA *m_objPtr;
            ...
            REGISTER_GETTER_INCLUDING_BASE_START(TestSerializableBase)
            ...
            TEST_F(SerializeNestedObjectTest, SimpleObject) {
                ...
                jvalue = Cmarshal::Json::ToJson(std::move(*objectA));
                VerifyClassA(*objectA, jvalue);
                cout << jvalue.serialize() << endl;

                jvalue = Cmarshal::Json::ToJson(*objectA);
                VerifyClassA(*objectA, jvalue);
                cout << jvalue.serialize() << endl;
            ...
            TEST_F(SerializeNestedObjectTest, NestedObject) {
                ...
                jvalue = Cmarshal::Json::ToJson(std::move(*objectB));
                VerifyClassB(*objectB, jvalue);
                cout << jvalue.serialize() << endl;

                jvalue = Cmarshal::Json::ToJson(*objectB);
                VerifyClassB(*objectB, jvalue);
                cout << jvalue.serialize() << endl;
            ...
            TEST_F(SerializeNestedObjectTest, NestedObject2) {
                ...
                jvalue = Cmarshal::Json::ToJson(std::move(*objectC));
                VerifyClassC(*objectC, jvalue);
                cout << jvalue.serialize() << endl;

                jvalue = Cmarshal::Json::ToJson(*objectC);
                VerifyClassC(*objectC, jvalue);
                cout << jvalue.serialize() << endl;
