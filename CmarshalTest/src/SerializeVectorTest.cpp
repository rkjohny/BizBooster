    ...
    namespace JsonTest {
        namespace TestSerializer {
            ...
            TEST_F(SerializeVectorTest, TestInt) {
                ...
                jvalue = Cmarshal::Json::ToJson(vector<int>({1, 2, 3}));
            ...
            TEST_F(SerializeVectorTest, TestScore) {
                ...
                jvalue = Cmarshal::Json::ToJson(std::move(*m_scores));
                ASSERT_TRUE(jvalue.is_array());
                ...
                jvalue = Cmarshal::Json::ToJson(*m_scores);
                ASSERT_TRUE(jvalue.is_array());
                ASSERT_TRUE(jvalue.as_array().size() == m_scores->size());
                itr = m_scores->begin();
                for (auto &arrItem : jvalue.as_array()) {
            ...
            TEST_F(SerializeVectorTest, TestNames) {
                ...
                jvalue = Cmarshal::Json::ToJson(vector<string>(*m_names));
                ASSERT_TRUE(jvalue.is_array());
                ...
                jvalue = Cmarshal::Json::ToJson(std::move(*m_names));
                ASSERT_TRUE(jvalue.is_array());
                ASSERT_TRUE(jvalue.as_array().size() == m_names->size());
                itr = m_names->begin();
                for (auto &arrItem : jvalue.as_array()) {
                ...
                jvalue = Cmarshal::Json::ToJson(*m_names);
                ASSERT_TRUE(jvalue.is_array());
                ASSERT_TRUE(jvalue.as_array().size() == m_names->size());
                itr = m_names->begin();
                for (auto &arrItem : jvalue.as_array()) {
            ...
            TEST_F(SerializeVectorTest, TestEmails) {
                ...
                jvalue = Cmarshal::Json::ToJson(vector<string *>(*m_emails));
                ASSERT_TRUE(jvalue.is_array());
                ...
                jvalue = Cmarshal::Json::ToJson(std::move(*m_emails));
                ASSERT_TRUE(jvalue.is_array());
                ASSERT_TRUE(jvalue.as_array().size() == m_emails->size());
                itr = m_emails->begin();
                for (auto &arrItem : jvalue.as_array()) {
                ...
                jvalue = Cmarshal::Json::ToJson(*m_emails);
                ASSERT_TRUE(jvalue.is_array());
                ASSERT_TRUE(jvalue.as_array().size() == m_emails->size());
                itr = m_emails->begin();
                for (auto &arrItem : jvalue.as_array()) {
            ...
            TEST_F(SerializeVectorTest, TestCities) {
                ...
                jvalue = Cmarshal::Json::ToJson(std::vector<char *>(m_cities));
                ASSERT_TRUE(jvalue.is_array());
                ...
                jvalue = Cmarshal::Json::ToJson(std::move(m_cities));
                ASSERT_TRUE(jvalue.is_array());
                ASSERT_TRUE(jvalue.as_array().size() == m_cities.size());
                itr = m_cities.begin();
                for (auto &arrItem : jvalue.as_array()) {
                ...
                jvalue = Cmarshal::Json::ToJson(m_cities);
                ASSERT_TRUE(jvalue.is_array());
                ASSERT_TRUE(jvalue.as_array().size() == m_cities.size());
                itr = m_cities.begin();
                for (auto &arrItem : jvalue.as_array()) {
