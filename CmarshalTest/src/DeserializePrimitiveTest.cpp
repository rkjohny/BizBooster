    ...
    namespace JsonTest {
        namespace TestDeserializer {
            ...
            TEST(DeSerilizaPirmitiveTest, SerializeInt) {
                ...
                Cmarshal::Json::FromJson(i, jvalue);
                ASSERT_EQ(10, i);
            ...
            TEST(DeSerilizaPirmitiveTest, SerializeVectInt) {
                ...
                Cmarshal::Json::FromJson(vec, jvalue);
            ...
            TEST(DeSerilizaPirmitiveTest, BoolTest) {
                ...
                Cmarshal::Json::FromJson(bval, jval);
                ASSERT_EQ(bval, true);
                ...
                Cmarshal::Json::FromJson(pbool, jval);
                // pbool is allocated
                ASSERT_EQ(*pbool, true);
                delete pbool;

                //pbool2 is NOT allocated
                Cmarshal::Json::FromJson(&pbool2, jval);
                ASSERT_EQ(*pbool2, true);
                delete pbool2;

                //pbool3 is allocated, but *pbbol3 is NOT
                pbool3 = new bool *();
                Cmarshal::Json::FromJson(pbool3, jval);
            ...
            TEST(DeSerilizaPirmitiveTest, CharTest) {
                ...
                charVal = 0;
                Cmarshal::Json::FromJson(charVal, jval);
                ASSERT_EQ('A', charVal);
            ...
            TEST(DeSerilizaPirmitiveTest, StringTest) {
                ...
                std::string str;
                Cmarshal::Json::FromJson(str, jval);
            ...
            TEST(DeSerilizaPirmitiveTest, Int8Test) {
                ...
                byte = 0;
                Cmarshal::Json::FromJson(byte, jval);
                ...
                Cmarshal::Json::FromJson(&int8Ptr, jval);
                ASSERT_EQ(100, *int8Ptr);
                delete int8Ptr;

                int8_t **int8Ptr2 = new int8_t *();
                Cmarshal::Json::FromJson(int8Ptr2, jval);
                ...
                ubyte = 1;
                Cmarshal::Json::FromJson(ubyte, jval);
                ASSERT_EQ(0, ubyte);
                ubyte = 1;
                Cmarshal::Json::FromJson(&ubyte, jval);
                ASSERT_EQ(0, ubyte);
                ...
                Cmarshal::Json::FromJson(&uint8Ptr, jval);
                ASSERT_EQ(200, *uint8Ptr);
                delete uint8Ptr;

                uint8_t **uint8Ptr2 = new uint8_t *();
                Cmarshal::Json::FromJson(uint8Ptr2, jval);
            ...
            TEST(DeSerilizaPirmitiveTest, Int16Test) {
                ...
                int16 = 0;
                Cmarshal::Json::FromJson(int16, jval);
                ...
                Cmarshal::Json::FromJson(&int16Ptr, jval);
                ASSERT_EQ(30000, *int16Ptr);
                delete int16Ptr;

                int16_t **int16Ptr2 = new int16_t *();
                Cmarshal::Json::FromJson(int16Ptr2, jval);
                ...
                uini16 = 1;
                Cmarshal::Json::FromJson(uini16, jval);
                ASSERT_EQ(0, uini16);
                uini16 = 1;
                Cmarshal::Json::FromJson(&uini16, jval);
                ASSERT_EQ(0, uini16);
                ...
                Cmarshal::Json::FromJson(&uint16Ptr, jval);
                ASSERT_EQ(40000, *uint16Ptr);
                delete uint16Ptr;

                uint16_t **uint16Ptr2 = new uint16_t *();
                Cmarshal::Json::FromJson(uint16Ptr2, jval);
            ...
            TEST(DeSerilizaPirmitiveTest, Int32Test) {
                ...
                int32 = 0;
                Cmarshal::Json::FromJson(int32, jval);
                ...
                Cmarshal::Json::FromJson(&int32Ptr, jval);
                ASSERT_EQ(2147483640, *int32Ptr);
                delete int32Ptr;

                int32_t **int32Ptr2 = new int32_t *();
                Cmarshal::Json::FromJson(int32Ptr2, jval);
                ...
                uini32 = 1;
                Cmarshal::Json::FromJson(uini32, jval);
                ASSERT_EQ(0, uini32);
                uini32 = 1;
                Cmarshal::Json::FromJson(&uini32, jval);
                ASSERT_EQ(0, uini32);
                ...
                Cmarshal::Json::FromJson(&uint32Ptr, jval);
                ASSERT_EQ(4294967290, *uint32Ptr);
                delete uint32Ptr;

                uint32_t **uint32Ptr2 = new uint32_t *();
                Cmarshal::Json::FromJson(uint32Ptr2, jval);
            ...
            TEST(DeSerilizaPirmitiveTest, Int64Test) {
                ...
                int64 = 0;
                Cmarshal::Json::FromJson(int64, jval);
                ...
                Cmarshal::Json::FromJson(&int64Ptr, jval);
                ASSERT_EQ(9223372036854775800, *int64Ptr);
                delete int64Ptr;

                int64_t **int64Ptr2 = new int64_t *();
                Cmarshal::Json::FromJson(int64Ptr2, jval);
                ...
                uini64 = 1;
                Cmarshal::Json::FromJson(uini64, jval);
                ASSERT_EQ(0, uini64);
                uini64 = 1;
                Cmarshal::Json::FromJson(&uini64, jval);
                ASSERT_EQ(0, uini64);
                ...
                Cmarshal::Json::FromJson(&uint64Ptr, jval);
                ASSERT_EQ(18446744073709551610UL, *uint64Ptr);
                delete uint64Ptr;

                uint64_t **uint64Ptr2 = new uint64_t *();
                Cmarshal::Json::FromJson(uint64Ptr2, jval);
            ...
            TEST(DeSerilizaPirmitiveTest, FloatTest) {
                ...
                fval = 0;
                Cmarshal::Json::FromJson(fval, jval);
                ...
                float *fptr = nullptr;
                Cmarshal::Json::FromJson(&fptr, jval);
                ASSERT_FLOAT_EQ(15.05, *fptr);
                delete fptr;

                float **fptr2 = new float *();
                Cmarshal::Json::FromJson(fptr2, jval);
