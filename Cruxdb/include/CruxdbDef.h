...
// 30 seconds
#define MAX_SESSION_MANAGER_THREAD_SLEEP_IN_NANOSECONDS (30L * 1000L * 1000L * 1000L)

// 30 minutes
#define DEFAULT_SESSION_TIME_OUT_IN_SECONDS (30 * 60)

//3 dayas
#define DEFAULT_TOKEN_TIME_OUT_IN_MINUTES (3 * 24 * 60)
